...
translate espanol v8_tues_evening_565c0af2:

    # u "(I must be imagining things... Or maybe I should just text someone?)"
    u "(I must be imagining things... Or maybe I should just text someone?)"

# game/v8/scene37.rpy:40
translate espanol v8s37_phoneContinue1_6b32f074:

    # u "I should reply to Lauren."
    u "I should reply to Lauren."

# game/v8/scene37.rpy:64
translate espanol v8s37_phoneContinue2_b2a97980:

    # u "I should reply to Riley."
    u "I should reply to Riley."

# game/v8/scene37.rpy:67
translate espanol v8s37_phoneContinue2_0d29d3a6:

    # u "(I guess this is just not my day for studying. Great job, [name]!)"
    u "(I guess this is just not my day for studying. Great job, [name]!)"

# game/v8/scene37.rpy:72
translate espanol v8s37_phoneContinue2_03be943f:

    # u "(If only something interesting would happen...)"
    u "(If only something interesting would happen...)"

# game/v8/scene37.rpy:80
translate espanol v8s37_phoneContinue2_565c0af2:

    # u "(I must be imagining things... Or maybe I should just text someone?)"
    u "(I must be imagining things... Or maybe I should just text someone?)"

# game/v8/scene37.rpy:108
translate espanol v8s37_phoneContinue3_6b32f074:

    # u "I should reply to Lauren."
    u "I should reply to Lauren."

# game/v8/scene37.rpy:132
translate espanol v8s37_phoneContinue4_95d895aa:

    # u "I should reply to my phone."
    u "I should reply to my phone."

# game/v8/scene37.rpy:135
translate espanol v8s37_phoneContinue4_0d29d3a6:

    # u "(I guess this is just not my day for studying. Great job, [name]!)"
    u "(I guess this is just not my day for studying. Great job, [name]!)"

# game/v8/scene37.rpy:140
translate espanol v8s37_phoneContinue4_03be943f:
