...
translate espanol strings:
    ...
    new "I'll talk to him later"

    # game/v14/scene4.rpy:27
    old "It's not that important"
    new "It's not that important"
