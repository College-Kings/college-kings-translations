# TODO: Translation updated at 2023-04-02 16:58 
...
translate espanol strings:
    ...
    new "No molestes a la Srta. Rose"

    # game/achievements.rpy:76
    old "Kiss Emily back"
    new "Devuélvele el beso a Emily"
    ...
    new "No te reúnieste con Grayson"
    ...
    new "Vuelve con Riley a casa"

    # game/achievements.rpy:84
    old "Pledge to the Apes"
    new "Comprométete con los Apes"

    # game/achievements.rpy:85
    old "Pledge to the Wolves"
    new "Comprométete con los Wolves"

    # game/achievements.rpy:86
    old "Pull down Mr. Lee's pants"
    new "Baja los pantalones del Sr. Lee"

    # game/achievements.rpy:87
    old "Bunk homecoming with Amber"
    new "Salta el baile con Amber"

    # game/achievements.rpy:88
    old "End homecoming with Lauren"
    new "Termina el baile con Lauren"

    # game/achievements.rpy:89
    old "End homecoming with Riley"
    new "Termina el baile con Riley"

    # game/achievements.rpy:90
    old "End homecoming with Chloe"
    new "Termina el baile con Chloe"

    # game/achievements.rpy:94
    old "Help Penelope"
    new "Ayuda Penelope"
    ...
    new "Trío con Riley y Aubrey"

    # game/achievements.rpy:182
    old "Don't let Ryan catch an STD"
    new "No dejes que Ryan contraiga una ETS"
