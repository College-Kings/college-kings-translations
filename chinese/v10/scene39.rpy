...
translate chinese v10_riley_walk_7c158eb4:
    ...
    ri "哈哈。那么，问题是，你介意送我回家吗？我和劳伦一起来的，但她要回鹿屋了。"
...
translate chinese v10_riley_walk_3c755fb0:
    ...
    ri "他们说你跳舞跳得越好，你的床上功夫就越好。是关于节奏的东西。 *咯咯笑*"
...
translate chinese v10_riley_walk_91586fd7:
    ...
    ri "另一方面，奥布里知道如何跳舞，所以我只能想象。你知道吗？"
...
translate chinese v10_riley_walk_4fdd3754:
    ...
    ri "我真的没怎么看，但我确实和很多人谈过。一旦发现我参加了主要活动，每个人都想和我谈谈。"
...
translate chinese v10_riley_walk_b16e29e9:
    ...
    ri "哦哦，你会觉得这很好笑的。我正好路过赢得一次约会摊位，看到李先生和罗斯女士正兴奋地交谈，所以我听了一会儿。"
...
translate chinese v10_riley_walk_888b87da:
    ...
    ri "不，真的，真的。我和其他女孩相处得很好，但就男人而言，我真正觉得亲密的人并不多。但我觉得和你很亲近。"
...
translate chinese v10_riley_walk_f3284190:
    ...
    ri "但是我也很高兴我们不仅仅是朋友。尤其是因为我今晚的计划。"
...
translate chinese v10_riley_walk_afa9ffc8:
    ...
    ri "不是我，我发誓我一直在认识新朋友。今天我遇到太多了。可以肯定地说，杰克逊在校园里是一个很受欢迎的名字。"
...
translate chinese v10_riley_walk_eaaa1226:
    ...
    ri "等等，他们看起来都有点像。我想知道他们是不是兄弟。杰克逊可能是他们的姓。"
...
translate chinese v10_riley_walk_b0462104:
    ...
    ri "他们中的一个刚刚说\"我们都叫杰克逊\"所以我……好吧，是的，这绝对是他们的姓。 *笑*"
