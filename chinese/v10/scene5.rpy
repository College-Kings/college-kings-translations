...
translate chinese v10_imre_vs_caleb_fight_17b978b3:

    # jo "Well, the show must go on."
    jo "嗯，演出必须继续进行。"

# game/v10/scene5.rpy:13
translate chinese v10_imre_vs_caleb_fight_7e634509:

    # jo "After this small delay, we're now finally ready for the first fight of the night."
    jo "经过这次小小的耽搁，我们现在终于准备好了今晚的第一场比赛。"

# game/v10/scene5.rpy:15
translate chinese v10_imre_vs_caleb_fight_07839494:
...
translate chinese v10_imre_vs_caleb_fight_4a6f411d:
    ...
    jo "不管怎样，看起来我们每个人都有赢家了！最有可能是创纪录的时间！"

# game/v10/scene5.rpy:76
translate chinese v10_imre_vs_caleb_fight_bed436de:

    # jo "Any words to the crowd after that amazing performance?"
    jo "在那令人惊叹的表演之后，有什么要对观众说的吗？"
