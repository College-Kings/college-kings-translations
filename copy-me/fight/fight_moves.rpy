# TODO: Translation updated at 2023-06-18 20:41
...
translate russian strings:
    ...
    new "Сохраните до 2 единиц выносливости, чтобы использовать их в следующем ходу."
    ...
    new "Следующая атака этим ходом игнорирует защиту"
    ...
    new "Сокрушительный удар по голове противника."

    # game/fight/fight_moves.rpy:119
    old "Opp has -2 Stamina at the start of their next turn if not blocked [[Once per turn]]"
    new "Оппонент получает -2 выносливости в начале следующего хода, если он не заблокирует [[Один раз за ход]]"
