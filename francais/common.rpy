...
translate francais strings:
    ...
    new "Les options de ce menu sont destinées à améliorer l'accessibilité. Ils peuvent ne pas fonctionner avec tous les jeux et certaines combinaisons d'options peuvent rendre le jeu injouable. Ce n'est pas un problème du jeu ou du moteur. Pour de meilleurs résultats lors de la modification des polices, essayez de conserver la même taille de texte qu'à l'origine."
    ...
    old "File page [text]"
    new "Page du fichier [text]"

    # renpy/common/00action_file.rpy:769
    old "Next file page."
    new "Page du fichier suivant."

    # renpy/common/00action_file.rpy:841
    old "Previous file page."
    new "Page précédente du fichier."
    ...
    new "Voulez-vous vraiment supprimer cette sauvegarde ?"
    ...
    new "Voulez-vous vraiment revenir au menu principal ?\nLa progression non enregistrée sera perdue."
    ...
    new "Voulez-vous vraiment passer le prochain choix ?"

    # renpy/common/00gui.rpy:391
    old "Are you sure you want to skip unseen dialogue to the next choice?"
    new "Êtes-vous sûr de vouloir passer les dialogues invisibles au prochain choix ?"

    # renpy/common/00keymap.rpy:300
    old "Failed to save screenshot as %s."
    new "Échec de l'enregistrement de la capture d'écran en tant que %s."
    ...
    new "Ce programme contient des logiciels libres sous un certain nombre de licences, notamment la licence MIT et la licence publique générale limitée GNU. Une liste complète des logiciels, y compris des liens vers le code source complet, est disponible {a=https://www.renpy.org/l/license}ici{/a}."
    ...
    new "avance automatique après clic"
    ...
    new "La voix-auto devrait dire \"[renpy.display.tts.last]\". Appuyez sur 'alt+shift+V' pour désactiver."

    # renpy/common/00preferences.rpy:575
    old "Self-voicing enabled. Press 'v' to disable."
    new "Voix-auto activée. Appuyez sur 'v' pour désactiver."
    ...
    new "Image [index] de [count] verrouillé."
    ...
    new "Avertissement de performances"
    ...
    new "Cet ordinateur a un problème d'affichage des graphiques : [problème]."
    ...
    new "Copie le fichier traceback.txt dans le presse-papiers en tant que BBcode pour les forums comme https://lemmasoft.renai.us/."
    ...
    new "Ouvre un terminal pour permettre le débogage du problème."
    ...
    new "Ouvre le fichier error.txt dans un éditeur de texte."

    # renpy/common/_errorhandling.rpym:690
    old "Copies the errors.txt file to the clipboard as BBcode for forums like https://lemmasoft.renai.us/."
    new "Copie le fichier error.txt dans le presse-papiers en tant que BBcode pour les forums comme https://lemmasoft.renai.us/."
