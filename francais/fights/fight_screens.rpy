...
screen fight_typeMenu():
    ...
    text "Les combats font partie intégrante de College Kings, mais tu peux simuler tous les combats si tu le souhaites.":
        align (0.5, 0.42)
    ...
    textbutton "Simulation : Victoire-auto":
        text_size 40
        align (0.5, 0.8)
        sensitive True
...
screen fight_selectDifficulty():
    ...
    text "Les difficultés plus élevées exigent des réactions plus rapides. Tu peux modifier ce point à tout moment dans les paramètres.":
        align (0.5, 0.42)
        font "fonts/OpenSans-Bold.ttf"
        color "#ffffff"
        xsize 500
...
screen fight_keybindOptions():
    ...
    vbox:
        ...
        textbutton "Modifier les touches":
            text_size 40
            action Call("fight_changeKeybinds")

        textbutton "Commencer le combat":
            text_size 40
            action Return()
