screen save_now(next_version):
    ...
    vbox:
        ...
        text "ATTENTION" color "#FF0000" xalign 0.5 size 105
        null height 100
        text "FIN DE LA VERSION ACTUELLE" xalign 0.5
        text "ENREGISTRE ICI POUR GARDER LA PROGRESSION" xalign 0.5
        null height 50
        text "NE CLIQUE PAS SUR CONTINUER AVANT D'AVOIR SAUVEGARDÉ !" xalign 0.5 size 50
...
screen end_screen(support_link="https://store.steampowered.com/app/1924480/College_Kings_2__Act_I/"):
    ...
    if not config.enable_steam:
        hbox:
            ...
            text "En exclusivité sur " size 40 yalign 0.5
    ...
    fixed:
        ...
        viewport:
            ...
            vbox:
                ...
                text "Un grand merci à tous les membres de la communauté et aux joueurs qui ont rendu ce projet possible."
