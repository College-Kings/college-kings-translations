...
translate empty v10_fight_result_34ffd3e7:
    ...
    jo "Je pense que comme nous nous y attendions tous, [name] a dominé ! Alors mesdames, si vous avez envie d'un gagnant ce soir, j'en ai trouvé un."
...
translate empty v10_fight_result_4cd684da:
    ...
    ry "J'ai travaillé dur pour ça et je l'ai eu ! Les Putain de Wolves sont nuls !"
