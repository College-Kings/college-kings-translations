# TODO: Translation updated at 2021-11-30 10:07
...
translate empty v10start_2b69d19e:
    ...
    imre "Reste reste en dehors de ça [name], putain ! C'est MON combat."
...
translate empty v10start_10bb488c:
    ...
    ry "Tu ne pourrais jamais défoncer quelqu'un, même si on te donnait une putain de machine à défoncer les gens !"

# game/v10/scene1.rpy:50
translate empty v10start_9ac6850d:

    # se "Alright guys, better stop here before it gets embarrassing."
    se "D'accord les gars, autant s'arrêter là, avant que ça devienne embarrassant."
...
translate empty v10start_a1e599de:
    ...
    u "(Ça devrait être un putain de spectacle.)"
...
translate francais v10start_2b69d19e:
    ...
    # imre "Stay the fuck out [name]! This is my fight."
    imre "Reste en dehors de ça [name], putain ! C'est MON combat."

# game/v10/scene1.rpy:28
translate francais v10start_33fb7619:

    # ry "You're gonna wish you hadn't called off your back up."
    ry "Tu vas regretter de ne pas avoir appelé ton remplaçant."

# game/v10/scene1.rpy:34
translate francais v10start_4e6aae5f:
...
# game/v10/scene1.rpy:50
translate francais v10start_9ac6850d:
...
# game/v10/scene1.rpy:75
translate francais v10start_a1e599de:
