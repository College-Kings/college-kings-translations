# TODO: Translation updated at 2021-11-30 18:16
...
translate empty v10_apes_samantha_5c3b6ed5:
    ...
    u "*Rire* Vraiment ? Je n'ai pas remarqué."
...
translate empty v10_apes_samantha_a709d6a4:
    ...
    sa "*Rire* Oui, c'est très subtil. Mais oui, il a toujours été une tête brûlée donc ça me semble logique qu'un gars comme lui se batte et soit dans une fraternité comme celle-ci, mais tu n'es pas comme lui et pourtant tu es dans cette fraternité aussi."
...
translate empty v10_apes_samantha_7fdcd055:
    ...
    u "Je peux être une tête brûlée au moins quand j'ai besoin de l'être, *glousse* parfois quand je veux l'être."
...
translate empty v10_apes_samantha_4caddde4:
    ...
    u "Au lycée, j'avais un professeur qui me cherchait toujours."
...
translate empty v10_apes_samantha_95972100:
    ...
    u "Les élèves faisaient toutes sortes de choses, ils lui lançaient des avions en papier pendant les cours, trichaient à ses examens et se moquaient de lui même quand il était dans la salle."
...
translate empty v10_apes_samantha_5f618586:
    ...
    u "Mais ils n'ont jamais eu de problèmes. Si je faisais quoi que ce soit de douteux, j'allais directement en détention."
...
translate empty v10_apes_samantha_23f6db01:
    ...
    u "A un moment donné, j'en ai eu vraiment marre et j'ai voulu l'énerver, lui faire la peau."
...
translate empty v10_apes_samantha_d7d75ef6:
    ...
    u "Pas tout à fait. Il a annoncé qu'il allait être l'un des chaperons de notre bal de promo et je savais que sa fille allait justement aller dans notre école et être diplômée avec moi."
...
translate empty v10_apes_samantha_5a247805:
    ...
    u "Donnnnc... pour faire court, j'ai demandé à sa fille d'aller au bal de fin d'année et - après quelques échanges très douloureux - elle a dit oui."
...
translate empty v10_apes_samantha_8cd64967:
    ...
    u "Pour être honnête, la fille n'était pas vraiment enthousiaste quand elle a découvert pourquoi je lui avais demandé, mais... ça valait vraiment le coup. *Rire*"
...
translate empty v10_apes_samantha_783c1171:
    ...
    u "*Rire* Qu'est-ce que c'est censé vouloir dire ?"
...
translate empty v10_apes_samantha_bb7e8d5f:
    ...
    sa "Tu sais... C'est juste que tu n'es pas vraiment le type fort et macho."
...
translate empty v10_apes_samantha_8d4b7f35:
    ...
    u "J'te f'rais dire que je peux être un dangereux lutteur de pouce. Aussi, j'aime toujours faire des conneries, j'essaye juste d'être intelligent à propos des conneries que je fais."

# game/v10/scene14.rpy:167
translate empty v10_apes_samantha_5cdd5204:

    # sa "*Laughs* Was that your senior quote or something?"
    sa "*Rire* C'était ta citation de fin d'études ou quoi ?"
...
translate empty v10_apes_samantha_4e2a4378:
    ...
    sa "*Rire* Alors tu étais le genre de type \"je peux copier sur toi\" ?"
...
translate empty v10_apes_samantha_cabed922:
    ...
    sa "Quel est le dicton ? \"Ne détestez pas le joueur, détestez le jeu.\""
...
translate empty v10_apes_samantha_f64071d3:
    ...
    ca "Qu'est-ce que vous faites, bordel ? [name], tu essayes de draguer ma soeur ?!"

# game/v10/scene14.rpy:213
translate empty v10_apes_samantha_63dee4ec:

    # u "Maybe I am, maybe I'm not. Why do you care?"
    u "Peut-être que oui, peut-être que non. Qu'est-ce que ça peut te faire ?"
...
translate empty v10_apes_samantha_199f4fd4:
    ...
    u "C'est ma faute, je n'avais pas réalisé que tu avais déjà dit preum's."
...
translate empty v10_apes_samantha_3bb6b427:
    ...
    u "Oh, je pense que je dois dire aux gars d'oublier que j'ai dit Preum's, alors."

# game/v10/scene14.rpy:278
translate empty v10_apes_samantha_88b3ce91:

    # sa "So you called dibs huh?"
    sa "Alors tu as dit preum's, hein ?"
...
translate empty v10_apes_samantha_866ba53b:
    ...
    u "Euh... il y a peut-être eu un appel à preum's à un moment donné dans le passé."
...
translate empty v10_apes_samantha_51cd4b26:
    ...
    sa "D'accord, j'ai des trucs à faire, à plus tard."
...
translate empty v10_apes_samantha_78338b42:
    ...
    u "(Ahh, elle est vraiment autre. Je devrais monter dans ma chambre.)"
...
translate empty v10_apes_samantha_16f6c574:
    ...
    ca "Samantha a déjà assez souffert et n'a pas besoin de subir tes conneries. Tu fais quoi que ce soit pour la contrarier et tu es mort."
...
translate empty v10_apes_samantha_cfb199af:
    ...
    u "(Il peut vraiment être un con parfois. Ce bon vieux Cameron. Je devrais monter dans ma chambre.)"

translate empty strings:

    # game/v10/scene14.rpy:81
    old "I can be a hothead"
    new "Je peux être une tête brûlée"

    # game/v10/scene14.rpy:81
    old "What's that supposed to mean?"
    new "Qu'est-ce que ça veut dire ?"
...
# game/v10/scene14.rpy:27
translate francais v10_apes_samantha_d0d17564:
...
# game/v10/scene14.rpy:67
translate francais v10_apes_samantha_5abedfb3:
...
translate francais v10_apes_samantha_199f4fd4:
    ...
    # u "My bad, I didn't realize you had called dibs already."
    u "C'est ma faute, je n'avais pas réalisé que tu avais déjà dit prem's."
