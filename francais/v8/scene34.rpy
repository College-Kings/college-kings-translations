...
translate francais v8_tues_noon_29a406f8:
    ...
    u "(Je me demande comment va Chloé. Je devrais lui envoyer un SMS.)"
...
translate francais strings:
    ...
    new "Tu as fini d'étudier ?"

    # game/v8/scene34.rpy:18
    old "Nothing. Bored."
    new "Rien. Je m'ennuie."

    # game/v8/scene34.rpy:22
    old "Good. Bored. You?"
    new "Bien. Je m'ennuie. Et toi ?"
    ...
    new "Alors quand est-ce que je peux te revoir ?"

    # game/v8/scene34.rpy:32
    old "I'm actually getting hungry. Wanna go grab a bite?"
    new "Je commence à avoir faim. Tu veux aller manger un morceau ?"
    ...
    new "Maintenant c'est parfait ! Je viens jouir chez toi ou tu veux jouir ici ? ;)"
    ...
    new "Eh bien, j'ai quelque chose pour remplir ta bouche"

    # game/v8/scene34.rpy:42
    old "Maybe after real food :P"
    new "Peut-être après la vraie nourriture :P"

    # game/v8/scene34.rpy:43
    old "What are you in the mood for? Lady's choice"
    new "De quoi es-tu d'humeur ? La dame choisit"
    ...
    new "Il y a un nouveau restaurant japonais juste en bas de la rue."

    # game/v8/scene34.rpy:59
    old "Sounds delicious. Meet you there!"
    new "Ça a l'air délicieux. Je t'y retrouve !"
    ...
    new "OMG ! Je pensais justement à toi !"
    ...
    new "Je pensais à tes lèvres :*"

    # game/v8/scene34.rpy:92
    old "Whatcha been up to?"
    new "Qu'est-ce que tu deviens ?"
