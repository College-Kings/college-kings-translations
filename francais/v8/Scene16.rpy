...
translate francais mc_wolves_sun_aft_e2049ac4:
    ...
    u "(Je suppose que je vais me détendre un peu.)"
...
translate francais strings:
    ...
    old "Took alot of work but Homecoming looks great"
    new "Ça à pris beaucoup de travail mais la fête a l'air bien"

    # game/v8/Scene16.rpy:11
    old "Thank you miss Rose also says thank you"
    new "Merci, Mlle Rose dit aussi merci"

    # game/v8/Scene16.rpy:14
    old "You will have to find out some times :)"
    new "Il faudra découvrir quelques fois :)"

    # game/v8/Scene16.rpy:17
    old "Not this time, but maybe next time you can join me ;)"
    new "Pas cette fois, mais peut-être que la prochaine fois tu pourras me rejoindre ;)"

    # game/v8/Scene16.rpy:35
    old "Hanging with my best friend. Good times!"
    new "Je sort avec ma meilleure amie. Bon temps !"

    # game/v8/Scene16.rpy:36
    old "Awww, I love hanging out with you <3"
    new "Oooh, j'adorerais sortir avec toi <3"
    ...
    new "Je suis contente que vous vous amusiez"

    # game/v8/Scene16.rpy:47
    old "Wow, you two look great!"
    new "Wow, vous êtes superbes toutes les deux !"

    # game/v8/Scene16.rpy:49
    old "Nothing like a good day of shopping"
    new "Rien de tel qu'une bonne journée de shopping"

    # game/v8/Scene16.rpy:50
    old "Wish I could of been there to try things with you"
    new "J'aurais aimé être là pour essayer des choses avec toi"
    ...
    new "Combien de bikinis as-tu acheté ? Haha."

    # game/v8/Scene16.rpy:53
    old "Did you buy me anything ?"
    new "M'as-tu acheté quelque chose ?"
