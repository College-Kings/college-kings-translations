# TODO: Translation updated at 2021-11-25 00:39
...
translate francais phn_penelope6_26a5b4a3:
    ...
    u "(Je devrais parler à Pénélope.)"
...
translate francais phn_penelope6_done_503de2c6:
    ...
    ch "Elle a des problèmes avec son père ou son mari. Je ne connais pas tous les détails..."
...
translate francais phn_penelope6_done_267776dd:
    ...
    ch "...mais elle avait l'air très bouleversée quand je l'ai croisée il y a quelques minutes et j'ai dit qu'on allait l'aider."
...
translate francais phn_penelope6_done_227600cb:
    ...
    ro "Merci beaucoup, les garçons. Je ne sais pas comment j'aurais pu faire tout ça avant que Mr Rose ne rentre."
...
translate francais phn_penelope6_done_7db5ebfa:
    ...
    ro "Hum... quand vous aurez fini ici, il y a encore des cartons dans la cuisine."
...
translate francais phn_penelope6_done_c0905d9e:
    ...
    ch "C'est pas une excuse. Vous méritez de vous sentir en sécurité dans votre propre maison."
...
translate francais phn_penelope6_done_e216c953:
    ...
    ro "Merci, les garçons. Je sais que ça ira mieux une fois que je serai partie d'ici."
...
translate francais phn_penelope6_done_134c71ea:
    ...
    u "Je vais euh... aller chercher d'autres cartons."
...
translate francais phn_penelope6_done_98d58592:
    ...
    # imre "How bad is it?"
    imre "C'est mauvais à quel point ?"
...
translate francais phn_penelope6_done_bb0636c1:
    ...
    ro "Il s'est cassé les deux jambes et... Ils lui ont donné des analgésiques. Au début, je lui en donnais quand il en avait besoin..."
...
translate francais phn_penelope6_done_c8414f0e:
    ...
    ch "Ce n'est pas votre faute. C'est un adulte."
...
translate francais phn_penelope6_done_dbb46555:
    ...
    la "Oh, fais-moi savoir si tu as le temps plus tard."
...
translate francais phn_penelope6_done_01897609:
    ...
    ro "...a été tellement en colère ces derniers temps."
...
translate francais phn_penelope6_done_6d9dbbff:
    ...
    u "Je vous avais dit qu'on s'occuperait de vous, Mme Rose !"
...
translate francais strings:
    ...
    new "Restez pour la consoler"

    # game/v8/scene17.rpy:145
    old "Focus on moving the boxes"
    new "Concentrez-vous sur le déménagement"
