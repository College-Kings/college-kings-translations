# TODO: Translation updated at 2021-11-24 16:20

# game/v8/scene3.rpy:8
translate francais v8_ri_start_50e057e6:

    # u "Mhm... Tell me more."
    u "Mmh... Dis m'en plus."

# game/v8/scene3.rpy:15
translate francais v8_ri_start_06f4585a:

    # ri "I'd rather show you instead."
    ri "Je préfère te le montrer."

# game/v8/scene3.rpy:25
translate francais v8_ri_start_90aaf8db:

    # ri "You like it?"
    ri "Tu aimes ça ?"

# game/v8/scene3.rpy:29
translate francais v8_ri_start_ca1593cc:

    # u "A pretty red-head in a sexy red lingerie?"
    u "Une jolie rousse dans une lingerie rouge sexy ?"
...
translate francais v8_ri_start_59d65f4a:
    ...
    ri "*Rire* Alors, pourquoi ne commencerais-tu pas à déballer ton cadeau ?"
...
translate francais v8_ri_start_b4d74582:

    # ri "Shh! Less talking, more action."
    ri "Chuuuut ! Moins de paroles, plus d'action."

# game/v8/scene3.rpy:57
translate francais v8_ri_start_05abfe32:

    # ri "Mmmmh..."
    ri "Mmmmh..."

# game/v8/scene3.rpy:61
translate francais v8_ri_start_3f547f36:

    # ri "Let's get these off."
    ri "Enlevons ça."

# game/v8/scene3.rpy:78
translate francais v8_ri_start_c6c9eea7:
...
translate francais v8_ri_start_87175e70:
    ...
    u "(Oh, elle commence à accélérer le rythme.)"

# game/v8/scene3.rpy:139
translate francais v8_ri_start_d839211b:
...
translate francais v8_ri_start_d5f0f25d:
    ...
    ri "Tu veux que j'aille plus vite ?"
...
translate francais v8_ri_start_9965325c:
    ...
    # u "(She's trying, but hasn't actually speed up much.)"
    u "(Elle essaie, mais n'a pas vraiment accéléré.)"

# game/v8/scene3.rpy:155
translate francais v8_ri_start_d30e26f0:
...
translate francais v8_ri_start_6676b031:
...
translate francais v8_ri_start_46b8446f:
...
translate francais v8_ri_start_831702b6:
    ...
    ri "[name]... Putain ! Je suis sur le point de... *gémis*"

# game/v8/scene3.rpy:203
translate francais v8_ri_start_e8b71f2f:

    # u "Ahh! I'm also close. Fuck!"
    u "Ahhh ! Je viens aussi. Putain !"

# game/v8/scene3.rpy:204
translate francais v8_ri_start_c9e65db6:
...
translate francais v8_ri_start_6da31428:
    ...
    ri "Je n'ai pas eu un tel orgasme depuis... toujours !"
...
translate francais v8_ri_start_b84e9fc9:

    # u "By the way, where's your roommate?"
    u "Au fait, où est ta colocataire ?"

# game/v8/scene3.rpy:259
translate francais v8_ri_start_8793c7f5:

    # ri "She isn't gonna be back until noon tomorrow."
    ri "Elle ne sera pas de retour avant demain midi."
...
translate francais v8_ri_start_e1a37bce:
    ...
    ri "Haha, je ne voulais pas dire ça, mais on verra."
...
translate francais v8s3_nsfwSkipLabel1_98220662:

    # u "(She's up already.)"
    u "(Elle est déjà debout.)"

# game/v8/scene3.rpy:312
translate francais v8s3_nsfwSkipLabel1_1f7d4f5a:
...
translate francais v8s3_nsfwSkipLabel1_0e0d37ca:
    ...
    ri "Oh rien, juste ce devoir que j'avais en attente."

# game/v8/scene3.rpy:324
translate francais v8s3_nsfwSkipLabel1_f15e04e7:

    # u "Riley... It's 7AM!"
    u "Riley... Il est 7h du mat' !"

# game/v8/scene3.rpy:328
translate francais v8s3_nsfwSkipLabel1_6237de07:

    # ri "Well..."
    ri "Bennn..."

# game/v8/scene3.rpy:332
translate francais v8s3_nsfwSkipLabel1_4597b3ef:

    # u "On a Saturday!"
    u "Un Samedi !"

# game/v8/scene3.rpy:336
translate francais v8s3_nsfwSkipLabel1_c3821aa5:

    # ri "It's-"
    ri "C'est-"

# game/v8/scene3.rpy:340
translate francais v8s3_nsfwSkipLabel1_c820ecb2:

    # u "Just after homecoming night."
    u "Juste après la soirée de rentrée."
...
translate francais v8s3_nsfwSkipLabel1_2a638174:
    ...
    ri "J'aime finir mon travail le plus tôt possible pour avoir du temps libre plus tard."
...
translate francais v8s3_nsfwSkipLabel1_29061286:
    ...
    # ri "It's, uh... 47 now."
    ri "C'est, euh... 47 maintenant."

# game/v8/scene3.rpy:361
translate francais v8s3_nsfwSkipLabel1_5963a69f:

    # u "Are you kidding me!?"
    u "Tu te fous de moi ?"

# game/v8/scene3.rpy:366
translate francais v8s3_nsfwSkipLabel1_8c2eb65a:
...
translate francais v8s3_nsfwSkipLabel1_497ec5d1:
    ...
    u "Quoi qu'il en soit, continue. Je vais aller me rafraîchir."
...
translate francais v8s3_rileyCowgirl_eda8b360:
...
# game/v8/scene3.rpy:139
translate francais v8s3_rileyCowgirl_73873b8e:

    # ri "[name]... you feel so good!"
    ri "[name]... tu as l'air si bien, en moi !"

# game/v8/scene3.rpy:144
translate francais v8s3_rileyCowgirl_87175e70:

    # u "(Oh, she's starting to pick up the pace.)"
    u "(Oh, elle commence à accélérer le rythme.)"

# game/v8/scene3.rpy:145
translate francais v8s3_rileyCowgirl_d839211b:
...
# game/v8/scene3.rpy:154
translate francais v8s3_rileyCowgirl_8a29721f:

    # u "If you can, yeah."
    u "Si tu peux, oui."

# game/v8/scene3.rpy:160
translate francais v8s3_rileyCowgirl_9965325c:
...
# game/v8/scene3.rpy:184
translate francais v8s3_rileyLiftDoggy_6676b031:
...
translate francais v8s3_rileyDoggy_b84e9fc9:

    # u "By the way, where's your roommate?"
    u "Au fait, où est ta colocataire ?"

# game/v8/scene3.rpy:269
translate francais v8s3_rileyDoggy_8793c7f5:
