# TODO: Translation updated at 2021-11-24 18:09
...
translate francais prot_w_au_24a00265:
    ...
    aut "De toute façon, c'est plus le message qui compte."
...
translate francais prot_w_au_no_wing_6523ea89:
    ...
    u "Ouais. Haha. J'aurais dû m'en douter."
...
translate francais prot_w_au_no_wing_6a8d8e35:
    ...
    aut "Ça peut être un peu accablant au début, mais rappele-toi toujours pourquoi nous sommes ici."
...
translate francais prot_w_au_leg_7a92024b:
    ...
    u "...Ouais, ouais ! C'est ce que je voulais dire."
...
translate francais prot_w_au_leg_60fb5ea1:
    ...
    aut "C'est fou que des représentants du gouvernement, surtout si l'on considère qu'ils sont tous des hommes pour la plupart, pensent qu'ils peuvent avoir leur mot à dire sur ce qu'une femme fait de son corps."
...
translate francais prot_w_au_leg_0709ae20:
    ...
    aut "Et c'est pourquoi nous sommes ici, n'est-ce pas ? Pour leur dire que \"notre corps est notre choix\". Nous ne pouvons pas continuer à laisser les hommes penser qu'ils ont leur mot à dire sur tout."
...
translate francais prot_w_au_leg_fa975d3c:
    ...
    aut "Exactement ! Contente que tu comprennes. Comme je l'ai déjà dit, c'est vraiment bien de connaître des gars qui ont leur mot à dire dans le mouvement des droits de la femme. Ce n'est pas souvent qu'on trouve des hommes qui sont prêts à soutenir les femmes et qui se battent avec elles."
...
translate francais prot_w_au_leg_651eafeb:
    ...
    u "Et c'est ainsi que l'on crée un mouvement, fort. L'un après l'autre, jusqu'à ce que tout le monde soit à bord."
...
translate francais prot_w_au_no_leg_d738dcf6:
    ...
    aut "Eh bien, je peux te mettre au courant... C'est dégueulasse. Une bande d'hommes misogynes et de responsables politiques ont introduit une législation pour essayer de rendre les avortements illégaux."
...
translate francais prot_w_au_no_leg_800620f0:
    ...
    aut "Pas si nous avons notre mot à dire. Le problème est dans les états conservateurs. Ils sont typiquement religieux et penchent pour des choses comme ça. Mais je dis, un homme ne devrait jamais avoir son mot à dire sur le corps d'une femme."
...
translate francais prot_w_au_no_leg_ccafd698:
    ...
    aut "C'est écoeurant, si tu veux mon avis. Un homme n'a pas à dire à une femme ce qu'elle peut ou ne peut pas faire avec son corps, et le gouvernement non plus. Les avortements sont légaux pour une multitude de raisons."
...
translate francais prot_w_au_no_leg_01ab6291:
    ...
    aut "Si quelqu'un veut mettre un enfant au monde, il doit être préparé. C'est comme ça que tant d'enfants finissent en famille d'accueil."
...
translate francais prot_w_au_no_leg_6aa06b77:
    ...
    aut "Oui ! Et merci de nous rejoindre, ce mouvement a besoin de plus d'hommes."
...
translate francais prot_w_au_2_4c411735:
    ...
    ev "Wow, tu n'as jamais mentionné que tu étais dans ce genre de truc. Je ne te voyais pas comme une personne politique."
...
translate francais prot_w_au_2_f8e10296:
    ...
    u "C'est une question importante. Alors j'ai pensé que je pourrais rejoindre la manifestation aujourd'hui."

# game/v8/scene8.rpy:390
translate francais prot_w_au_2_4dab1d54:

    # ev "That's amazing. Wish you told me before."
    ev "C'est incroyable. J'aurais aimé que tu m'en parles avant."
...
translate francais prot_w_au_2_af417fec:
    ...
    ev "Haha. Eh ben, non. J'ai passé un bon moment. Mais honnêtement, c'est excitant un homme qui vient à une manifestation de femmes pour les droits des femmes. Je pense qu'un vrai homme devrait être comme ça."
...
translate francais prot_w_au_2_5c51aa6b:
    ...
    ev "Haha. Oui, ça fait du bien d'en être un peu plus proche, tu sais. Mais assez parlé de moi, comment ça va ?"
...
translate francais prot_w_au_2_92a5e557:
    ...
    u "Bien. Toujours pareil. Devoirs et études. Il faut garder ses bonnes notes. Aucuns problèmes."
...
translate francais prot_w_au_2_7123a591:
    ...
    ev "Ah j'adore Autumn ! Elle vient à chacune de ces manifestations. C'est une femme forte. Et très intelligente."
...
translate francais strings:
    ...
    new "Prétendre que tu sais ce que tu fais"
    ...
    new "Fais semblant d'être au courant"
...
# game/v8/scene8.rpy:120
translate francais prot_w_au_wing_3468a7ad:
    ...
    aut "C'est bien. C'est bien de connaître des gens qui s'y connaissent en politique et dans les problèmes auxquels nous sommes confrontés chaque jour dans la société."
# TODO: Translation updated at 2022-01-18 10:42

# game/v8/scene8.rpy:146
translate francais prot_w_au_no_wing_cff7cd1f:

    # aut "It's okay. We're just here to make our voices heard, that's all."
    aut "Ça va. Nous sommes juste ici pour faire entendre notre voix, c'est tout."

# game/v8/scene8.rpy:409
translate francais prot_w_au_2_1490d901:

    # ev "Definitely a compliment."
    ev "C'est un vrai compliment."
