# TODO: Translation updated at 2021-11-29 18:24

# game/v9/scene31.rpy:22
translate francais v9_sat_cafe_w_nora_2476391f:

    # no "It feels good to have a nice meal once in awhile."
    no "Ça fait du bien d'avoir un bon repas de temps en temps."
...
translate francais v9_sat_cafe_w_nora_ac079442:
    ...
    no "T'es vraiment obligé de demander ? On a passé beaucoup de temps ensemble quand on a commencé à sortir ensemble, mais maintenant c'est comme si je passais après les Wolves."
...
translate francais v9_sat_cafe_w_nora_dd3f3a9e:
    ...
    no "Wow, sous ce crâne épais tu n'es pas aussi ennuyeux que le reste de ces têtes de veaux."

# game/v9/scene31.rpy:48
translate francais v9_sat_cafe_w_nora_c8e4e4ad:
...
translate francais v9_sat_cafe_w_nora_44c25675:
    ...
    u "Nous sommes juste des amis, en fait."

# game/v9/scene31.rpy:67
translate francais v9_sat_cafe_w_nora_3c8f81cb:

    # waiter "Ahhh okay, what will you be having today?"
    waiter "Ahhhh okay, qu'est-ce que vous allez prendre aujourd'hui ?"
...
translate francais v9_sat_cafe_w_nora_20c7b874:
    ...
    no "Merci d'avoir demandé."

# game/v9/scene31.rpy:101
translate francais v9_sat_cafe_w_nora_f0c7c13c:

    # no "I had a really good time [name]. Wish I could do this more often."
    no "J'ai passé un très bon moment [name]. J'aimerais pouvoir faire ça plus souvent."

# game/v9/scene31.rpy:106
translate francais v9_sat_cafe_w_nora_8c6198f5:

    # u "Maybe we can."
    u "Peut-être que nous le pourrons."
...
translate francais v9_sat_cafe_w_nora_2027a26c_1:
...
translate francais v9_sat_cafe_w_nora_f0c7c13c_1:

    # no "I had a really good time [name]. Wish I could do this more often."
    no "J'ai passé un très bon moment [name]. J'aimerais pouvoir faire ça plus souvent."

# game/v9/scene31.rpy:162
translate francais v9_sat_cafe_w_nora_8c6198f5_1:
...
translate francais v9_sat_cafe_7720a2b5:
    ...
    # u "Uh, yeah that's me."
    u "Euh, ouais c'est moi."

# game/v9/scene31.rpy:207
translate francais v9_sat_cafe_cfecf5c5:

    # unknown "Wow, I can't believe it's you. Like you're actually here in front of me right now."
    unknown "Wow, je n'arrive pas à croire que c'est toi. Et que tu es là, devant moi, en ce moment même."

# game/v9/scene31.rpy:212
translate francais v9_sat_cafe_8eb7f5ad:

    # u "Thanks..."
    u "Merci..."

# game/v9/scene31.rpy:217
translate francais v9_sat_cafe_a061b1dc:

    # unknown "Can I sit with you or is that too much? No that's too much, or is it? OMG, you're so stupid. Not you, me. OMG!"
    unknown "Je peux m'asseoir avec toi ou c'est trop ? Non, c'est trop, ou pas ? Oh merde, tu es tellement stupide. Pas toi, moi. Aaaargh !"

# game/v9/scene31.rpy:222
translate francais v9_sat_cafe_d653b00c:
...
translate francais v9_sat_cafe_cb76e0dd:
    ...
    unknown "Tout le monde appellerait ça se faire botter le cul, y compris moi."

# game/v9/scene31.rpy:243
translate francais v9_sat_cafe_67e48a73:

    # u "(Okay... bitch.)"
    u "(Ok... salope.)"

# game/v9/scene31.rpy:248
translate francais v9_sat_cafe_cf7579f5:

    # u "(Well, let the crazy begin.)"
    u "(Eh bien, que la folie commence.)"
