# TODO: Translation updated at 2021-12-07 18:28
...
translate francais v11_treasure_hunt_b6f4afc7:
    ...
    ri "Ok, tu sais quand on a dit que c'était soit un stand de tir, soit du tir au pigeon ?"
...
translate francais v11_treasure_hunt_7814d7a6:
    ...
    ri "Eh bien, la seule chose que j'ai pu trouver en termes de tir, c'est un endroit appelé \"Duncan's Airsofting\"."

# game/v11/scene20.rpy:45
translate francais v11_treasure_hunt_b8729849:

    # u "Duncan's? That has to be it, right?"
    u "\"Duncan\" ? Ça doit être ça, non ?"
...
translate francais v11_treasure_hunt_8c793fe0:
    ...
    ri "Moi aussi je le pense. En plus, j'ai regardé l'adresse en ligne et c'est seulement à 5 minutes de l'hôtel."
...
translate francais v11_treasure_hunt_b8b32797:
    ...
    ri "Oh, arrête de pleurnicher. L'énigme est la suivante : \"Au fin fond de Londres, vous trouverez Mr Duncan, pas dans un restaurant, mais où les hommes armés font du tir.\""
...
translate francais v11_treasure_hunt_4a2d663e:
    ...
    ri "\"Beaucoup de cibles, faites attention à Londres, une balle est rapide et arrive presque trop soudainement.\""
...
translate francais v11_treasure_hunt_49bf4e1c:
    ...
    dun "Bonjour, puis-je vous renseigner ?"
...
translate francais v11_treasure_hunt_549931c2:
    ...
    ri "Nous ne sommes pas trop sûrs. On pense qu'on cherche un homme qui s'appelle Duncan."

# game/v11/scene20.rpy:155
translate francais v11_treasure_hunt_d33351c7:

    # dun "How did you two come across this map?"
    dun "Comment avez-vous trouvé cette carte ?"
...
translate francais v11_treasure_hunt_b0cacf20:
    ...
    u "Notre professeur nous l'a donné et nous a demandé de la suivre jusqu'au bout."
...
translate francais v11_treasure_hunt_b10e1d62:
    ...
    dun "Vous comprenez qu'il s'agit d'une carte très importante et que ceux d'entre nous qui, comme moi, protègent les indices, la prennent très au sérieux ?"

# game/v11/scene20.rpy:170
translate francais v11_treasure_hunt_b579e14a:

    # ri "See [name], told you it was real."
    ri "Tu vois [name], je t'ai dit que c'était vrai."

# game/v11/scene20.rpy:175
translate francais v11_treasure_hunt_c8e750be:

    # dun "Oh, so you're a doubter?"
    dun "Oh, donc vous êtes un sceptique ?"
...
translate francais v11_treasure_hunt_fbac045c:
    ...
    ri "Non, ce n'est pas un sceptique. Donc vous nous donnez la prochaine énigme, ou indice, ou quelque chose ?"
...
translate francais v11_treasure_hunt_8ef55680:
    ...
    dun "Seulement après avoir terminé l'épreuve. Seules les âmes les plus courageuses peuvent avoir accès aux indices restants."
...
translate francais v11_treasure_hunt_ca423ded:
    ...
    dun "Et vous le devez aussi, monsieur. Si elle rate."
...
translate francais v11_treasure_hunt_4732cd0c:
    ...
    dun "J'ai mis deux balles dans cette arme. L'un d'entre vous tirera d'abord avec le fusil, en essayant d'obtenir la cible. Si cette personne ne réussit pas son essai, l'autre devra tirer à son tour."
...
translate francais v11_treasure_hunt_952159b7:
    ...
    dun "Si tous les deux vous n'arrivez pas à mettre dans le mille, le trésor ne sera pas à vous."
...
translate francais v11_treasure_hunt_d228f554:
    ...
    ri "Quoi ?! Vous dites sérieusement qu'on n'a qu'une seule chance ?"

# game/v11/scene20.rpy:255
translate francais v11_treasure_hunt_e6687fe3:

    # dun "Well, two shots. One for each of you."
    dun "Eh bien, deux coups. Une chance pour chacun d'entre vous."
...
translate francais v11_treasure_hunt_7a709810:
    ...
    ri "Comment est-ce possible pour nous de faire ça sans avoir aucune pratique ou expérience ou-"
...
translate francais v11_treasure_hunt_72e26c6b:
    ...
    dun "\"Une farce stupide\", monsieur ?"
...
translate francais v11_treasure_hunt_f8a4df52:
    ...
    ri "*Rire* Eh bien... Peu importe ce que c'est, tradition ou pas. Nous le découvrirons bien assez tôt."
...
translate francais v11_treasure_hunt_b00317a5:
    ...
    dun "Attendez ! Vous devez tous les deux vous mettre d'accord sur qui tirera le premier."
...
translate francais v11_treasure_hunt_ae46521f:
    ...
    u "Pourquoi est-ce important de savoir qui y va en premier si on doit tirer tous les deux de toute façon ?"
...
translate francais v11_treasure_hunt_4ec74496:
    ...
    dun "Ah, donc vous devez penser que si votre amie ici présente passe la première, vous devrez tirer de toute façon, parce qu'elle manquera le tir ?"

# game/v11/scene20.rpy:306
translate francais v11_treasure_hunt_8e6ee98b:

    # u "Those are my expectations, yeah. Sorry Riley."
    u "Ce sont mes prévisions, oui. Désolé Riley."
...
translate francais v11_treasure_hunt_389170ac:
    ...
    ri "Ok, [name]. *Rire* Si tu es si sûr de toi, tu commences."
...
translate francais v11_treasure_hunt_a7f19033:
    ...
    u "Ok... J'ai juste besoin de me concentrer..."
...
translate francais v11_treasure_hunt_40ae7edb:
    ...
    u "Oh, merde... Je suis désolé Riley, je..."
...
translate francais v11_treasure_hunt_5c0d85d8:
    ...
    ri "*Rire* C'est bon, [name]. Mais tu pourrais peut-être être un peu moins arrogant la prochaine fois ? *Rire*"
...
translate francais v11_treasure_hunt_7c72e0b5:
    ...
    ri "EST-CE QUE JE VIENS D'AVOIR LA CIBLE ?!"
...
translate francais v11_treasure_hunt_d6c8ef1e:
    ...
    u "OUI ! Tu viens de mettre dans le mille, Riley ! Comment t'as fait ça, bordel ?"

# game/v11/scene20.rpy:396
translate francais v11_treasure_hunt_13a3b5e0:

    # ri "I guess it just comes naturally... *Chuckles*"
    ri "Je crois que c'est venu naturellement... *Rire*"
...
translate francais v11_treasure_hunt_d1981963:
    ...
    ri "Oh non... Je suis vraiment désolée ! Tu dois mettre dans le mille, [name]. C'est notre seule chance !"

# game/v11/scene20.rpy:445
translate francais v11_treasure_hunt_9bd26f39:

    # u "(Fuck...) It's okay... I just need to focus..."
    u "(Putain...) C'est bon... J'ai juste besoin de me concentrer..."
...
translate francais v11_treasure_hunt_81083ef3:
    ...
    dun "Eh bien, vous savez quoi ? Vous deux devez être les élus... Hmmph."
...
translate francais v11_treasure_hunt_7b15cc9a:
    ...
    u "*Chuchote* \"Les élus\" ? Qu'est-ce qui se passe ici, Riley ? *Rire*"
...
translate francais v11_treasure_hunt_111dbc2b:
    ...
    ri "*Chuchote* Haha, chut ! *Rire* Allons chercher la prochaine partie de l'énigme et partons d'ici."
...
translate francais v11_treasure_hunt_979a9194:
    ...
    dun "Ce trésor ne peut être trouvé par personne d'autre que vous-mêmes. Vous comprenez ?"
...
translate francais v11_treasure_hunt_4f39dc72:
    ...
    lee "Je vois. Eh bien, vous arrivez juste à temps. Nous allons au musée et pendant que les autres élèves feront la visite avec Mlle Rose, vous serez tout deux avec moi."
