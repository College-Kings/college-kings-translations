...
translate francais v11s4_PhoneContinueEmily1_dc79bd0c:
    ...
    u "(Allons voir de quoi il s'agit.)"
...
translate francais v11s4_PhoneContinueEmily1_bb06c5a0:
    ...
    em "Je suis fatiguée de te voir avec d'autres filles. Appelle-moi jalouse ou autre, mais je ne peux plus être là avec toi, te voyant faire tout ça."
...
translate francais v11s4_PhoneContinueEmily1_8e486c86:
    ...
    em "Je vois le flirt, je vois la façon dont tu les regardes, je vois, beaucoup trop. Et je ne peux plus supporter ça."
...
translate francais v11s4_PhoneContinueEmily1_72f518ab:
    ...
    em "Un de mes amis m'a donné beaucoup de bons conseils récemment... et je pense que je dois commencer à l'écouter."
...
translate francais v11s4_PhoneContinueEmily1_034de290:
    ...
    u "On n'est pas obligé de se fréquenter, mais on peut quand même être amis."
...
translate francais v11s4_PhoneContinueEmily1_d124b944:
    ...
    em "Ou, au moins l'une d'entre nous voulait une vraie relation. Donc je suis désolée, mais ça ne marchera pas."
...
translate francais v11s4_PhoneContinueEmily1_191a9439:
    ...
    em "Je vais quand même faire le voyage en Europe, mais... ne t'attends pas à ce qu'on se parle."

# game/v11/scene4.rpy:184
translate francais v11s4_PhoneContinueEmily1_ea38217f:

    # u "If that's what you want."
    u "Si c'est ce que tu veux."
...
translate francais v11s4_PhoneContinueEmily1_6185d0a5:
    ...
    em "Et je sais que tu pars en voyage en Europe, alors ne m'attends pas là-bas."
...
translate francais v11s4_PhoneContinueEmily1_7a51fe2c:
    ...
    em "C'est tout ce que je voulais dire. Au revoir, [name]."
