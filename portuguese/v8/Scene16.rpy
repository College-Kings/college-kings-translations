...
translate portuguese mc_wolves_sun_aft_e2049ac4:

    # u "(Guess I'll chill out for a bit.)"
    u "(Acho que vou descansar um pouco.)"

# game/v8/Scene16.rpy:49
translate portuguese mc_apes_sun_aft_e2049ac4:
...
translate portuguese strings:
    ...
    new "A próxima vez me convida"

    # game/v8/Scene16.rpy:39
    old "Looking hot, ladies!"
    new "Gatíssimas, senhoritas!"
    ...
    new "Me divertindo com a Prof. Rose!"
    ...
    new "Quantos bikinis você comprou? Haha"
