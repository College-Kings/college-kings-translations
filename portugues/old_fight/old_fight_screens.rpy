...
translate portugues strings:
    ...
    new "A luta faz parte do College Kings, no entanto, você pode simular todas as lutas, se desejar."
    ...
    new "Dificuldades maiores requerem reações mais rápidas. Você pode alterar isso a qualquer momento nas configurações."
    ...
    old "\n[q!u] = Jab / Block Head\n[w!u] = Hook / Block Face\n[e!u] = Kick / Block Leg"
    new "\n[q!u] = Soco / Bloqueio de Cabeça\n[w!u] = Gancho / Bloqueio de face\n[e!u] = Chute / Bloqueio de Perna"

    # game/old_fight/old_fight_screens.rpy:136
    old "Keybinding"
    new "Combinação de teclas"

    # game/old_fight/old_fight_screens.rpy:145
    old "\n[r!u] = Body Hook / Low Guard"
    new "\n[r!u] = Gancho de Corpo / Guarda Baixa"

    # game/old_fight/old_fight_screens.rpy:148
    old "The current keybindings are: [keybindText]"
    new "As combinações de teclas atuais são: [keybindText]"
